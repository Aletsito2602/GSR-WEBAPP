...
export function AuthProvider({ children }) {
  ...
  const refreshUserClaims = async () => {
    ...
    try {
      console.log("Forzando actualización del token y perfil de usuario...");
      ...
      // Volver a sincronizar el perfil desde Firestore para obtener los últimos cambios
      console.log("Sincronizando perfil actualizado desde Firestore...");
      await syncUserWithFirestore(currentUser);
      console.log("Perfil de usuario sincronizado desde Firestore");
